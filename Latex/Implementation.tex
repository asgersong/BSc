...
\section{Case Study}
    %This case study focuses on applying a low-rank approximation technique, specifically LoRA, to compress a BART-base model for dialogue summarization tasks. The following subsections detail the implementation specifics, the evaluation metrics used to gauge the model's performance, and the methodology for selecting the optimal rank for the low-rank layers.
