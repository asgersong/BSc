...
\usepackage{subcaption}				% Muliggoer at have flere billeder i en figur
\usepackage{soul}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\textit{Bridging the Gap}}
...
\usepackage[backend=bibtex,style=authoryear,natbib=true,bibencoding=ascii,sorting=none]{biblatex}
